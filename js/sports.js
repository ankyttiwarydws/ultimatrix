...
const sportsPages = [
    { title: "Cricket: India vs South Africa 1st Test", url: "/sports/cricket/cricket.html" },
    { title: "Football: Manchester United vs Real Madrid", url: "/sports/football/football.html" },
    { title: "Super Bowl LIX: Chiefs vs Eagles", url: "/sports/superbowl/superbowl.html" },
    { title: "Chess: FIDE Grand Swiss 2025", url: "/sports/chess/chess.html" },
    { title: "Tennis: Wimbledon Semi-finals", url: "/sports/tennis/tennis.html" },
    { title: "Hockey: Asia Cup 2025 Final", url: "/sports/hockey/hockey.html" }
  ...
  searchBar.addEventListener('input', function (e) {
    ...
    const matches = sportsPages.filter(page => page.title.toLowerCase().includes(query));
    if (matches.length > 0) {
